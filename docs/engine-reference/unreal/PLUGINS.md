...
**🟡 Brief Overview Only** - Links to official docs; use Codex web research for details
...
## On-Demand Official Documentation Research

For plugins NOT listed above, use the following approach when users ask:

1. Use Codex web research to find the latest official documentation: `"Unreal Engine 5.7 [plugin name]"`
