...
>
> Proposed bounded changeset: add this Philosophy section to `design/ux/hud.md`. Apply it?
...
>
> Proposed bounded changeset: update `design/ux/screens/inventory.md`, then re-run the accessibility check. Apply it?
