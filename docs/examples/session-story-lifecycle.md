...
>
> Proposed bounded changeset: update `production/stories/STORY-MOV-001.md` and set Status to `ready-for-dev`. Apply it?
...
>
> Proposed bounded changeset: mark the story Complete, add Completion Notes, and update `production/sprint-status.yaml`. Apply it?
