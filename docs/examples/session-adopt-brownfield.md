...
>
> Proposed bounded changeset: write this plan to `docs/adoption-plan-2026-03-12.md`. Apply it?
...
>
> Proposed bounded changeset: write this index to `design/gdd/systems-index.md`. Apply it?
