...
>
> Proposed bounded changeset: write the accepted design to `design/gdd/crafting-system.md`. Apply it?
...
- Each section's design decision was reviewed before moving on; file writes stayed within one bounded authorization
- Explicit permission requested before applying a not-yet-authorized changeset file
...
- Turn 10: Agent requested approval before applying a not-yet-authorized changeset file
