...
Invoke this workflow as `$art-bible`.
...
**Retrofit mode detection**: Find files matching `design/art/art-bible.md`. If the file exists:
- Read it in full
...
Ask the user directly with two question groups:
- Question group **"Scope"** — "Which sections need to be authored today?"
...
- Write each section to file immediately after the single changeset approval — continue without re-prompting
