...
- [ ] If the workflow modifies files, it follows the changeset authorization policy below
...
- [ ] No files written outside the authorized changeset
...
- [ ] Requests new direction only for a material scope expansion or separately gated destructive/external action
- [ ] Ends with a recommended next step or follow-up action
- [ ] Does not auto-create files outside the authorized changeset
