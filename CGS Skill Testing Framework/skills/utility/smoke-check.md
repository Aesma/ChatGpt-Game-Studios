...
### Case 3: Manual Confirmation — user-input request used, PASS WITH WARNINGS
...
3. `user-input request` is used for Batch 1 and Batch 2 — developer confirms all PASS
...
**Assertions:**
- [ ] `user-input request` is used for manual smoke check batches (not inline text prompts)
...
- The `--platform` argument adds platform-specific user-input request batches and a
