#!/bin/bash
# Codex SessionStart hook: load project context as extra developer context.
# Codex provides a JSON object on stdin; this handler does not need its fields.
...
echo "=== ChatGPT Game Studios — Session Context ==="
