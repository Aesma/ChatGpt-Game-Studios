...
Context is the most critical resource in a Codex task. Manage it actively.
...
3. Persist each accepted section within the already-authorized bounded changeset; do not re-prompt for the write
