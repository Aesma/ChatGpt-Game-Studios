...
3. **Present 2-3 strategic options:**
   ...
   - *After the full analysis, use `user-input request` to capture the decision*
...
Use the `user-input request` tool to present strategic decisions as a selectable UI.
