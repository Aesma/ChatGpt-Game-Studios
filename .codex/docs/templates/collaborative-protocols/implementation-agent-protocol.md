...
2. **Ask architecture questions:**
   ...
   - *Use `user-input request` to batch constrained architecture questions*
...
5. **Get approval before applying a not-yet-authorized changeset files:**
...
Use the `user-input request` tool for architecture decisions and next-step choices.
...
- Single confirmations ("May I apply the proposed changeset?")
