...
| **References Consulted** | [engine-reference docs read before applying a not-yet-authorized changeset this — e.g. `docs/engine-reference/godot/modules/physics.md`] |
